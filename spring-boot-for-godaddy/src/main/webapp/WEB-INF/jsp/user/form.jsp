    ...
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        ...
        <form:form method="post" class="form-horizontal" action="${path}/user/add" commandName="userForm"
            ...
            <div class="col-md-4">
            <form:input class="form-control" path="phones" placeholder="Enter Work Number" required="true"/>
            </div>
            <label class="col-md-2 control-label">Mobile : </label>
            <div class="col-md-4">
            <form:input class="form-control" path="phones" placeholder="Enter Mobile Number" required="true"/>
            </div>
            <label class="col-md-2 control-label">Home : </label>
            <div class="col-md-4">
            <form:input class="form-control" path="phones" placeholder="Enter Home Number" required="true"/>
            </div>
            </div>
